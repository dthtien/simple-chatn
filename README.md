...
* [x] Clicking the "add friends" link takes the user to a page with all users listxed, with a link to "add user to friends list". 
* [x] Clicking on ["new message"] _search user to create conversation_ takes the user to a page where they can write a new mesasge. The recipient field should be a dropdown, where the options are names from the user's friends.
